...
odoo.define('pos_partner_limit.models', function (require) {
    "use strict";
    ...
    models.PosModel = models.PosModel.extend({
        load_server_data: function () {
            ...
            var partner_model = self.models[product_index];
            if (!("domain" in partner_model)) {
                partner_model['domain'] = function(self) {return [['show_in_pos', '=', true]];};
            }
